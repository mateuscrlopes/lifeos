...
### 🕒 Fatia 2 — Conexão estoque ↔ lista (ADIADO — na fila)
- Item baixo vira sugestão na lista de compras (identificada como sugestão).
- Ao marcar compra, perguntar a **quantidade real** e atualizar o estoque.
- Conversão de pacote: o caso "12 vs 24 rolos" do Documento Mestre (seção 16.1)
  entra aqui — quantidade planejada ≠ quantidade comprada.
